"""PPO inference implementation with dual forecasts (LSTM + PatchTST).
...
def run_ppo_inference(
    ...
    Args:
        ...
        lstm_forecasts: LSTM predictions for each symbol.
        patchtst_forecasts: PatchTST predictions for each symbol.

...
This module provides the single source of truth for halal stock universe
fetching. Used by both brain_api and news_sentiment_etl.
"""
...
def get_halal_symbols() -> set[str]:
    """Get just the set of halal stock symbols.

    Convenience function for filtering operations.

    Returns:
        Set of uppercase stock symbols from halal ETFs
    """
    universe = get_halal_universe()
    return {stock["symbol"].upper() for stock in universe["stocks"]}
